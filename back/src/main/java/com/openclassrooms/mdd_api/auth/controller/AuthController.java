...
/**
 * Contrôleur REST d'authentification : CSRF, inscription, connexion, refresh et déconnexion.
 * <p>
 * Émet les cookies refreshToken et accessToken (HttpOnly), exige le header X-XSRF-TOKEN sur les requêtes mutantes.
 * </p>
 */
