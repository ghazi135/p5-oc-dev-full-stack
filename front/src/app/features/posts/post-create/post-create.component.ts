...
import { TopicListItem } from '@features/topics/models/topic.models';
import { PostsApiService } from '@features/posts/posts-api.service';
import { CreatePostRequest } from '@features/posts/models/post.models';
...
export class PostCreateComponent {
  ...
  /**
   * Message d'erreur à afficher pour un champ (serveur prioritaire, sinon validation client).
   */
  getDisplayError(field: 'topicId' | 'title' | 'content'): string | null {
    const server = firstServerError(this.fieldErrors(), field);
